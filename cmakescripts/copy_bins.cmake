file(GLOB_RECURSE _file_list RELATIVE "${src_dir}" "${src_dir}/*.dll" "${src_dir}/*.ilk" "${src_dir}/*.pdb" "${src_dir}/*.manifest")
...
foreach (each_file ${_file_list})
    ...
    if (NOT EXISTS ${destinationfile} OR ${sourcefile} IS_NEWER_THAN ${destinationfile})
        ...
        message(${each_file} copied)
    else ()
        message(${each_file} up to date.)
    endif ()
